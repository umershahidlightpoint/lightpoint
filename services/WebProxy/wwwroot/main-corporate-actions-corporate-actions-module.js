...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"row\">\r\n\r\n    <!-- Symbol Filter -->\r\n    <div class=\"col-auto\">\r\n      <input type=\"text\" autocomplete=\"off\" placeholder=\"Filter by Symbol\" name=\"symbol\" [(ngModel)]=\"filterBySymbol\"\r\n        (ngModelChange)=\"ngModelChangeSymbol($event)\" (keyup)=\"onSymbolKey($event)\" class=\"form-control\" />\r\n    </div>\r\n    <!-- Symbol Filter Ends -->\r\n  \r\n    <!-- Date Picker Div Starts -->\r\n    <div class=\"col-auto\">\r\n      <form>\r\n        <input ngxDaterangepickerMd class=\"form-control\" type=\"text\" placeholder=\"Choose date\" [(ngModel)]=\"selected\"\r\n          (ngModelChange)=\"ngModelChangeDates($event)\" name=\" selected\" [autoApply]=\"true\" [alwaysShowCalendars]=\"true\"\r\n          [keepCalendarOpeningWithRange]=\"true\" />\r\n      </form>\r\n    </div>\r\n    <!-- Date Picker Div Ends -->\r\n  \r\n    <!-- Clear Button Div Starts -->\r\n    <div class=\"col-auto\">\r\n      <button (click)=\"clearFilters()\" class=\"btn btn-pa\" value=\"clear\" tooltip=\"Clear\" placement=\"top\">\r\n        <i class=\"fa fa-remove\"></i>\r\n      </button>\r\n    </div>\r\n    <!-- Clear Button Div Ends -->\r\n  \r\n    <!-- Util Buttons Div Starts -->\r\n    <div class=\"col-auto ml-auto\">\r\n  \r\n      <!-- Refresh Button Div Starts -->\r\n      <div class=\"mr-2 d-inline-block\">\r\n        <button (click)=\"refreshReport()\" class=\"btn btn-pa\" value=\"refresh\" tooltip=\"Refresh\" placement=\"top\">\r\n          <i class=\"fa fa-refresh\"></i></button>\r\n      </div>\r\n      <!-- Refresh Button Div Ends -->\r\n  \r\n      <div class=\"mr-2 d-inline-block\">\r\n        <button class=\"btn btn-pa\" type=\"button\" value=\"showModal\" (click)=\"openStockSplitModal()\"\r\n          tooltip=\"Change symbol\" placement=\"top\">\r\n          <i class=\"fa fa-plus\" aria-hidden=\"true\"></i>\r\n        </button>\r\n      </div>\r\n  \r\n      <!-- Expand/Collapse Button -->\r\n      <div class=\"mr-3 d-inline-block\">\r\n        <ng-template #tooltipTemplate>{{stockSplitConfig.detailsView ? 'Expand' : 'Collapse'}}</ng-template>\r\n        <button (click)=\"stockSplitConfig.detailsView = !stockSplitConfig.detailsView\" class=\"btn btn-pa\"\r\n          [tooltip]=\"tooltipTemplate\" placement=\"top\">\r\n          <i class=\"fa\"\r\n            [ngClass]=\"{'fa-arrow-down': stockSplitConfig.detailsView, 'fa-arrow-up': !stockSplitConfig.detailsView}\"></i>\r\n        </button>\r\n      </div>\r\n  \r\n    </div>\r\n    <!-- Util Buttons Div Ends -->\r\n  \r\n  </div>\r\n  \r\n  <!-- Main Split Row Starts -->\r\n  <div class=\"split-area row h-100\" style=\"margin-top: 20px;\">\r\n  \r\n    <!-- AS Split Main Container -->\r\n    <as-split class=\"pl-15 pr-15\" disabled=\"false\" direction=\"vertical\" [useTransition]=\"stockSplitConfig.useTransition\"\r\n      (dragEnd)=\"applyPageLayout($event)\" (transitionEnd)=\"applyPageLayout($event)\">\r\n  \r\n      <!-- Cost Basis Split Area -->\r\n      <as-split-area [visible]=\"stockSplitConfig.stockSplitView\" [size]=\"stockSplitConfig.stockSplitSize\" order=\"1\">\r\n  \r\n  \r\n        <ag-grid-angular class=\"w-100 h-100 ag-theme-balham\" [gridOptions]=\"gridOptions\"\r\n          (rowSelected)=\"onRowSelected($event)\" [rowData]=\"rowData\">\r\n        </ag-grid-angular>\r\n  \r\n      </as-split-area>\r\n  \r\n      <!-- Charts Split Area -->\r\n      <as-split-area [visible]=\"stockSplitConfig.detailsView\" [size]=\"stockSplitConfig.detailsSize\" order=\"2\">\r\n        <div class=\"w-100 h-100 mt-3 tabset-wrapper grid-height\">\r\n          <tabset class=\"w-100 height-45 mt-3\">\r\n            <tab class=\"h-100\" heading=\"Details\" (selectTab)=\"activeStockSplits()\">\r\n              <!-- <ag-grid-angular class=\"w-100 h-100 ag-theme-balham\" style=\"margin-top: 20px;\"\r\n                [gridOptions]=\"stockSplitDetailsGrid\" (rowSelected)=\"onRowSelected($event)\" [rowData]=\"rowData\">\r\n              </ag-grid-angular> -->\r\n            </tab>\r\n  \r\n            <!-- <tab heading=\"Preview\">\r\n              <app-stock-splits-preview></app-stock-splits-preview>\r\n            </tab> -->\r\n          </tabset>\r\n        </div>\r\n      </as-split-area>\r\n  \r\n    </as-split>\r\n  \r\n  </div>\r\n  \r\n  <app-create-symbol-rename #symbolRenameModal (modalClose)=\"closeSymbolChangeModal()\">\r\n  </app-create-symbol-rename>\r\n  \r\n  <!-- Data Grid Modal Component Selector Starts -->\r\n  <app-data-grid-modal #dataGridModal [gridTitle]=\"title\">\r\n  </app-data-grid-modal>\r\n  <!-- Data Grid Modal Component Selector Ends -->\r\n  \r\n  <app-create-security #securityModal (modalClose)=\"closeSecurityModal()\"></app-create-security>\r\n  \r\n  <!-- Confirmation Modal Selector -->\r\n  <app-confirmation-modal #confirmationModal [title]=\"'Delete Stock Split'\" (confirmed)=\"deleteStockSplit()\">\r\n  </app-confirmation-modal>\r\n  <!-- Confirmation Modal Selector Ends -->");
...
var CorporateActionsComponent = /** @class */ (function () {
    ...
    CorporateActionsComponent.prototype.activeSymbolRename = function () {
...
/* harmony import */ var _symbol_rename_symbol_rename_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./symbol-rename/symbol-rename.component */ "./src/app/main/corporate-actions/symbol-rename/symbol-rename.component.ts");
/* harmony import */ var _dividends_preview_preview_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./dividends/preview/preview.component */ "./src/app/main/corporate-actions/dividends/preview/preview.component.ts");
/* harmony import */ var _corporate_actions_route__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./corporate-actions.route */ "./src/app/main/corporate-actions/corporate-actions.route.ts");
...
/* harmony import */ var _stock_splits_stock_splits_preview_stock_splits_preview_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./stock-splits/stock-splits-preview/stock-splits-preview.component */ "./src/app/main/corporate-actions/stock-splits/stock-splits-preview/stock-splits-preview.component.ts");
...
var corporateActionsComponents = [
    ...
    _dividends_preview_preview_component__WEBPACK_IMPORTED_MODULE_15__["PreviewComponent"],
    _stock_splits_stock_splits_preview_stock_splits_preview_component__WEBPACK_IMPORTED_MODULE_18__["StockSplitsPreviewComponent"],
    _symbol_rename_symbol_rename_component__WEBPACK_IMPORTED_MODULE_14__["SymbolRenameComponent"]
];
var CorporateActionsModule = /** @class */ (function () {
    ...
    CorporateActionsModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            exports: corporateActionsComponents.concat([src_app_shared_module__WEBPACK_IMPORTED_MODULE_17__["SharedModule"]]),
            imports: [
                ...
                _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild(_corporate_actions_route__WEBPACK_IMPORTED_MODULE_16__["CorporateActionsRoutes"]),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("::ng-deep .rightAlign {\n  text-align: right;\n}\n\n::ng-deep .tabset-wrapper .tab-content {\n  height: 100% !important;\n}\n\n.grid-height {\n  height: calc(100% - 84px) !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("::ng-deep .rightAlign {\n  text-align: right;\n}\n\n.grid-height {\n  height: calc(100% - 84px) !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
/***/ "./src/app/main/corporate-actions/symbol-rename/symbol-rename.component.scss":
/*!***********************************************************************************!*\
  !*** ./src/app/main/corporate-actions/symbol-rename/symbol-rename.component.scss ***!
  \***********************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("::ng-deep .rightAlign {\n  text-align: right;\n}\n\n.grid-height {\n  height: calc(100% - 84px) !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */");

/***/ }),

/***/ "./src/app/main/corporate-actions/symbol-rename/symbol-rename.component.ts":
/*!*********************************************************************************!*\
  !*** ./src/app/main/corporate-actions/symbol-rename/symbol-rename.component.ts ***!
  \*********************************************************************************/
/*! exports provided: SymbolRenameComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SymbolRenameComponent", function() { return SymbolRenameComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var src_shared_Component_grid_layout_menu_grid_layout_menu_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/shared/Component/grid-layout-menu/grid-layout-menu.component */ "./src/shared/Component/grid-layout-menu/grid-layout-menu.component.ts");
/* harmony import */ var src_shared_utils_AppEnums__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/shared/utils/AppEnums */ "./src/shared/utils/AppEnums.ts");
/* harmony import */ var src_shared_utils_ContextMenu__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/shared/utils/ContextMenu */ "./src/shared/utils/ContextMenu.ts");
/* harmony import */ var src_shared_Modal_create_symbol_rename_create_symbol_rename_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/shared/Modal/create-symbol-rename/create-symbol-rename.component */ "./src/shared/Modal/create-symbol-rename/create-symbol-rename.component.ts");
/* harmony import */ var src_shared_Modal_create_security_create_security_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/shared/Modal/create-security/create-security.component */ "./src/shared/Modal/create-security/create-security.component.ts");
/* harmony import */ var src_shared_Component_data_grid_modal_data_grid_modal_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/shared/Component/data-grid-modal/data-grid-modal.component */ "./src/shared/Component/data-grid-modal/data-grid-modal.component.ts");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! moment */ "./node_modules/moment/moment.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_8__);
...
var SymbolRenameComponent = /** @class */ (function () {
    function SymbolRenameComponent(cdRef, cacheService, corporateActionsApiService, securityApiService, toastrService) {
        this.cdRef = cdRef;
        this.cacheService = cacheService;
        this.corporateActionsApiService = corporateActionsApiService;
        this.securityApiService = securityApiService;
    ...
    SymbolRenameComponent.prototype.ngOnInit = function () {
        this.initGrid();
        this.getSymbolsChange();
    };
    SymbolRenameComponent.prototype.ngAfterViewInit = function () {
        this.initPageLayout();
    };
    SymbolRenameComponent.prototype.initPageLayout = function () {
        var persistUIState = this.cacheService.getConfigByKey(src_shared_utils_AppEnums__WEBPACK_IMPORTED_MODULE_3__["LayoutConfig"].persistUIState);
        if (!persistUIState || !JSON.parse(persistUIState.value)) {
            return;
        }
    ...
    SymbolRenameComponent.prototype.applyPageLayout = function (event) {
        if (event.sizes) {
            this.stockSplitConfig.stockSplitSize = event.sizes[0];
            this.stockSplitConfig.detailsSize = event.sizes[1];
        }
    ...
    SymbolRenameComponent.prototype.getSymbolsChange = function () {
        var _this = this;
        this.corporateActionsApiService.getSymbolsChange().subscribe(function (response) {
            _this.gridOptions.api.hideOverlay();
            if (response.statusCode === 200) {
                _this.data = response.payload;
                _this.gridOptions.api.sizeColumnsToFit();
    ...
    SymbolRenameComponent.prototype.getStockSplitDetails = function (id) {
        var _this = this;
        this.stockSplitConfig.detailsView = true;
        this.stockSplitDetailsGrid.api.showLoadingOverlay();
        this.corporateActionsApiService.getStockSplitDetails(id).subscribe(function (response) {
    ...
    SymbolRenameComponent.prototype.initGrid = function () {
        var _this = this;
        this.gridOptions = {
            rowData: null,
            pinnedBottomRowData: [],
    ...
    SymbolRenameComponent.prototype.openEditModal = function (data) {
        this.symbolRenameModal.openModal(data);
    };
    SymbolRenameComponent.prototype.openStockSplitModal = function () {
        this.symbolRenameModal.openModal(null);
    };
    SymbolRenameComponent.prototype.closeSymbolChangeModal = function () {
        this.gridOptions.api.showLoadingOverlay();
        this.getSymbolsChange();
        this.stockSplitDetailsGrid.api.setRowData([]);
    };
    SymbolRenameComponent.prototype.deleteStockSplit = function () {
        var _this = this;
        this.corporateActionsApiService.deleteSymbolChange(this.toBeDeletedStockSplit).subscribe(function (response) {
            if (response.isSuccessful) {
                _this.toastrService.success('Symbol deleted successfully!');
                _this.closeSymbolChangeModal();
            }
            else {
                _this.toastrService.error('Failed to delete Symbol!');
            }
        }, function (error) {
            _this.toastrService.error('Something went wrong. Try again later!');
        });
    };
    SymbolRenameComponent.prototype.rowSelected = function (row) {
        var id = row.data.id;
        // let node;
        // this.stockSplitDetailsGrid.api.forEachLeafNode(rowNode => {
        //   if (rowNode.data.id === id) {
    ...
    /////////// External Filters Code //////////////
    SymbolRenameComponent.prototype.onSymbolKey = function (e) {
        this.filterBySymbol = e.srcElement.value;
        this.gridOptions.api.onFilterChanged();
        // For the moment we react to each key stroke
        if (e.code === 'Enter' || e.code === 'Tab') {
    ...
    SymbolRenameComponent.prototype.onFilterChanged = function () {
        // this.pinnedBottomRowData = CalTotalRecords(this.gridOptions);
        this.gridOptions.api.setPinnedBottomRowData(this.pinnedBottomRowData);
    };
    SymbolRenameComponent.prototype.ngModelChangeSymbol = function (e) {
        this.filterBySymbol = e;
        this.gridOptions.api.onFilterChanged();
    };
    SymbolRenameComponent.prototype.ngModelChangeDates = function (e) {
        if (!this.selected.startDate) {
            return;
        }
        this.startDate = e.startDate;
    ...
    SymbolRenameComponent.prototype.isExternalFilterPassed = function (object) {
        var symbolFilter = object.symbolFilter;
        var dateFilter = object.dateFilter;
        this.filterBySymbol = symbolFilter !== undefined ? symbolFilter : this.filterBySymbol;
        this.setDateRange(dateFilter);
    ...
    SymbolRenameComponent.prototype.setDateRange = function (dateFilter) {
        var dates = Object(src_shared_utils_Shared__WEBPACK_IMPORTED_MODULE_11__["SetDateRange"])(dateFilter, this.startDate, this.endDate);
        this.startDate = dates[0];
        this.endDate = dates[1];
        this.selected =
    ...
    SymbolRenameComponent.prototype.isExternalFilterPresent = function () {
        if (this.filterBySymbol !== '' || this.startDate) {
            return true;
        }
    };
    SymbolRenameComponent.prototype.doesExternalFilterPass = function (node) {
        if (this.filterBySymbol !== '' && this.startDate) {
            var cellSymbol = node.data.old_symbol === null ? '' : node.data.old_symbol;
            var cellDate = new Date(node.data.execution_date);
            return (cellSymbol.toLowerCase().includes(this.filterBySymbol.toLowerCase()) &&
                this.startDate.toDate() <= cellDate &&
                this.endDate.toDate() >= cellDate);
    ...
    SymbolRenameComponent.prototype.getExternalFilterState = function () {
        return {
            symbolFilter: this.filterBySymbol,
            dateFilter: {
                startDate: this.startDate !== undefined ? this.startDate : '',
    ...
    SymbolRenameComponent.prototype.refreshReport = function () {
        this.gridOptions.api.showLoadingOverlay();
        this.stockSplitDetailsGrid.api.showLoadingOverlay();
        this.getSymbolsChange();
        this.stockSplitDetailsGrid.api.setRowData([]);
    ...
    SymbolRenameComponent.prototype.clearFilters = function () {
        this.selected = null;
        this.filterBySymbol = '';
        this.stockSplitConfig.detailsView = false;
        this.startDate = moment__WEBPACK_IMPORTED_MODULE_8__('01-01-1901', 'MM-DD-YYYY');
    ...
    /////////// End External Filters Code //////////////
    SymbolRenameComponent.prototype.getContextMenuItems = function (params) {
        var _this = this;
        var addDefaultItems = [{
                name: 'Edit',
                action: function () {
                ...
                subMenu: [
                    {
                        ...
                        action: function () {
                            _this.isLoading = true;
                            _this.securityApiService.getDataForSecurityModal(params.node.data.old_symbol).subscribe(function (_a) {
                                var config = _a[0], securityDetails = _a[1];
                                _this.isLoading = false;
                                if (!config.isSuccessful) {
                                    _this.toastrService.error('No security type found against the selected symbol!');
                                ...
                                if (securityDetails.payload.length === 0) {
                                    _this.securityModal.openSecurityModalFromOutside(params.node.data.old_symbol, config.payload[0].SecurityType, config.payload[0].Fields, null, 'extend');
                                }
                                else {
                                    _this.securityModal.openSecurityModalFromOutside(params.node.data.old_symbol, config.payload[0].SecurityType, config.payload[0].Fields, securityDetails.payload[0], 'extend');
                                }
                            }, function (error) {
                                _this.isLoading = false;
                            });
    ...
    SymbolRenameComponent.prototype.openDeleteDividendModal = function (id) {
        this.toBeDeletedStockSplit = id;
        this.confirmationModal.showModal();
    };
    SymbolRenameComponent.prototype.openDataGridModal = function (rowNode) {
        var _this = this;
        var id = rowNode.node.data.id;
        this.corporateActionsApiService.getSymbolChangeAudit(id).subscribe(function (response) {
            var payload = response.payload;
            var columns = _this.getAuditColDefs();
            var modifiedCols = columns.map(function (col) {
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, col, { editable: false });
            });
            _this.title = 'Symbol Change Audit Trail';
            _this.dataGridModal.openModal(modifiedCols, payload);
        });
    };
    SymbolRenameComponent.prototype.getAuditColDefs = function () {
        return [
            {
                field: 'id',
                width: 120,
    ...
    SymbolRenameComponent.ctorParameters = function () { return [
        { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"] },
        { type: src_services_common_cache_service__WEBPACK_IMPORTED_MODULE_9__["CacheService"] },
        { type: _services_corporate_actions_api_service__WEBPACK_IMPORTED_MODULE_10__["CorporateActionsApiService"] },
        { type: src_services_security_api_service__WEBPACK_IMPORTED_MODULE_14__["SecurityApiService"] },
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('symbolRenameModal', { static: false }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", src_shared_Modal_create_symbol_rename_create_symbol_rename_component__WEBPACK_IMPORTED_MODULE_5__["CreateSymbolRenameComponent"])
    ], SymbolRenameComponent.prototype, "symbolRenameModal", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('dataGridModal', { static: false }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", src_shared_Component_data_grid_modal_data_grid_modal_component__WEBPACK_IMPORTED_MODULE_7__["DataGridModalComponent"])
    ], SymbolRenameComponent.prototype, "dataGridModal", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('securityModal', { static: false }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", src_shared_Modal_create_security_create_security_component__WEBPACK_IMPORTED_MODULE_6__["CreateSecurityComponent"])
    ], SymbolRenameComponent.prototype, "securityModal", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('confirmationModal', { static: false }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", src_shared_Component_confirmation_modal_confirmation_modal_component__WEBPACK_IMPORTED_MODULE_12__["ConfirmationModalComponent"])
    ], SymbolRenameComponent.prototype, "confirmationModal", void 0);
    SymbolRenameComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-symbol-rename',
            template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./symbol-rename.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/main/corporate-actions/symbol-rename/symbol-rename.component.html")).default,
            styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./symbol-rename.component.scss */ "./src/app/main/corporate-actions/symbol-rename/symbol-rename.component.scss")).default]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"],
            src_services_common_cache_service__WEBPACK_IMPORTED_MODULE_9__["CacheService"],
            _services_corporate_actions_api_service__WEBPACK_IMPORTED_MODULE_10__["CorporateActionsApiService"],
