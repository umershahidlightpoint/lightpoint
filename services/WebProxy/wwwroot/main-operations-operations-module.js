...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("/******************************\n****  Component UI Styles  ****\n******************************/\n.file-input {\n  padding: 0.2rem;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
/* harmony import */ var src_shared_utils_DownloadExcelUtils__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/shared/utils/DownloadExcelUtils */ "./src/shared/utils/DownloadExcelUtils.ts");
/* harmony import */ var src_shared_utils_Shared__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/shared/utils/Shared */ "./src/shared/utils/Shared.ts");
...
var FileUploadComponent = /** @class */ (function () {
    function FileUploadComponent(toastrService, financeService, fundTheoreticalApiService, dataDictionary, downloadExcelUtils) {
        this.toastrService = toastrService;
        ...
        this.previewData = [];
        this.rowData = [];
        this.ignoreFields = src_shared_utils_Shared__WEBPACK_IMPORTED_MODULE_9__["IgnoreFields"];
        ...
        this.fileTypes = ['Monthly Performance', 'Daily PnL', 'Market Prices', 'FxRates', 'Trades'];
        this.styleForLogsHeight = Object(src_shared_utils_Shared__WEBPACK_IMPORTED_MODULE_9__["HeightStyle"])(220);
    }
        ...
        this.previewGrid = {
            ...
            defaultColDef: {
                ...
                cellStyle: function (params) {
                    var exception = JSON.parse(params.data.UploadException);
                    if (exception) {
                        var invalid = exception.Fields.some(function (element) { return element.Name === params.colDef.headerName; });
                        if (invalid) {
                            return src_shared_utils_Shared__WEBPACK_IMPORTED_MODULE_9__["LegendColors"].nonZeroStyle;
                        }
                    }
                    else {
                        return null;
                ...
                tooltipValueGetter: function (params) {
                    ...
                    if (exception) {
                        var message_1 = '';
                        var invalid = exception.Fields.some(function (element) {
            ...
            onGridReady: function (params) {
                lp_toolkit__WEBPACK_IMPORTED_MODULE_3__["GridUtils"].autoSizeAllColumns(params);
                _this.previewGrid.excelStyles = src_shared_utils_Shared__WEBPACK_IMPORTED_MODULE_9__["ExcelStyle"];
            },
            onFirstDataRendered: function (params) {
                lp_toolkit__WEBPACK_IMPORTED_MODULE_3__["GridUtils"].autoSizeAllColumns(params);
            },
            onCellClicked: function (params) {
                ...
                if (params.data.UploadException) {
                    _this.exceptionContent =
                        exception.Fields.find(function (element) { return element.Name === params.colDef.headerName; }) || {};
                }
                else {
                    _this.exceptionContent = {};
                }
    ...
    FileUploadComponent.prototype.onChangeFileType = function (selectedFileType) {
        this.disableFileUpload =
            this.fileToUpload === null || this.fileType === 'Select a File Type' ? true : false;
        this.fileType = selectedFileType;
    };
    FileUploadComponent.prototype.onDownloadTemplate = function () {
        this.excelTemplate(this.fileType, this.fileType + " Sheet");
    };
    FileUploadComponent.prototype.excelTemplate = function (fileName, sheetName) {
        var params = {
            fileName: fileName,
            sheetName: sheetName
        };
    ...
    FileUploadComponent.prototype.onUploadFile = function () {
        var _this = this;
        this.exceptionContent = '';
    ...
    FileUploadComponent.prototype.onCommitData = function () {
    ...
    FileUploadComponent.prototype.uploadMonthlyPerformance = function () {
        ...
        this.financeService.uploadMonthlyPerformance(this.fileToUpload).subscribe(function (response) {
            ...
            if (response.isSuccessful) {
                _this.displayPreviewGrid = false;
    ...
    FileUploadComponent.prototype.uploadDailyUnofficialPnl = function () {
        var _this = this;
        this.uploadLoader = true;
        this.fundTheoreticalApiService.uploadDailyUnofficialPnl(this.fileToUpload).subscribe(function (response) {
            _this.uploadLoader = false;
            if (response.isSuccessful) {
                _this.displayPreviewGrid = false;
                _this.displayGrid = false;
    ...
    FileUploadComponent.prototype.uploadTradeData = function () {
        var _this = this;
        this.uploadLoader = true;
        this.fundTheoreticalApiService.uploadTradeData(this.fileToUpload).subscribe(function (response) {
            _this.uploadLoader = false;
            if (response.isSuccessful && response.statusCode === 200) {
                _this.displayPreviewGrid = true;
                _this.displayGrid = false;
                _this.disableCommit = !response.payload.EnableCommit;
                _this.previewData = response.payload.Data;
                _this.previewGrid.api.setColumnDefs(_this.getColDefs('Trades'));
                _this.previewGrid.api.setRowData(_this.previewData);
                _this.toastrService.success('Trades uploaded successfully!');
            }
            else {
                _this.toastrService.error(response.ExceptionMessage);
            }
        }, function (error) {
            _this.uploadLoader = false;
            _this.toastrService.error('Something went wrong! Try Again.');
    ...
    FileUploadComponent.prototype.commitTradeData = function () {
        var _this = this;
        this.commitLoader = true;
        this.fundTheoreticalApiService.commitTradeData(this.previewData).subscribe(function (response) {
            _this.commitLoader = false;
            if (response.isSuccessful && response.statusCode === 200) {
                _this.displayPreviewGrid = false;
                _this.displayGrid = false;
                _this.previewGrid.api.setRowData([]);
                _this.clearForm();
                _this.toastrService.success('Trades committed successfully!');
            }
            else {
                _this.toastrService.error('Something went wrong! Try Again.');
            }
    ...
    FileUploadComponent.prototype.getColDefs = function (fileType) {
        switch (fileType) {
    ...
    FileUploadComponent.ctorParameters = function () { return [
        ...
        { type: src_shared_utils_DownloadExcelUtils__WEBPACK_IMPORTED_MODULE_8__["DownloadExcelUtils"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    FileUploadComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [ngx_toastr__WEBPACK_IMPORTED_MODULE_2__["ToastrService"],
            src_services_service_proxies__WEBPACK_IMPORTED_MODULE_5__["FinanceServiceProxy"],
            ...
            src_shared_utils_DownloadExcelUtils__WEBPACK_IMPORTED_MODULE_8__["DownloadExcelUtils"]])
    ], FileUploadComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("body,\nhtml {\n  margin: 0;\n  padding: 0;\n  height: 100%;\n}\n\n.modal {\n  background-color: rgba(0, 0, 0, 0.4);\n}\n\n.modal-backdrop {\n  position: relative;\n}\n\n.modal-dialog {\n  position: relative;\n  width: auto;\n  max-width: 600px;\n  margin: 10px;\n}\n\n.modal-sm {\n  max-width: 300px;\n}\n\n.modal-lg {\n  max-width: 900px;\n}\n\n@media (min-width: 768px) {\n  .modal-dialog {\n    margin: 30px auto;\n  }\n}\n\n@media (min-width: 320px) {\n  .modal-sm {\n    margin-right: auto;\n    margin-left: auto;\n  }\n}\n\n@media (min-width: 620px) {\n  .modal-dialog {\n    margin-right: auto;\n    margin-left: auto;\n  }\n\n  .modal-lg {\n    margin-right: 10px;\n    margin-left: 10px;\n  }\n}\n\n@media (min-width: 920px) {\n  .modal-lg {\n    margin-right: auto;\n    margin-left: auto;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
/* harmony import */ var _operations_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./operations.component */ "./src/app/main/operations/operations.component.ts");
/* harmony import */ var _operations_file_exception_file_exception_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../operations/file-exception/file-exception.component */ "./src/app/main/operations/file-exception/file-exception.component.ts");
/* harmony import */ var _operations_file_management_file_management_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../operations/file-management/file-management.component */ "./src/app/main/operations/file-management/file-management.component.ts");
/* harmony import */ var _operations_file_upload_file_upload_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../operations/file-upload/file-upload.component */ "./src/app/main/operations/file-upload/file-upload.component.ts");
/* harmony import */ var src_app_main_operations_silver_file_management_silver_file_management_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! src/app/main/operations/silver-file-management/silver-file-management.component */ "./src/app/main/operations/silver-file-management/silver-file-management.component.ts");
/* harmony import */ var src_app_main_operations_services_status_services_status_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! src/app/main/operations/services-status/services-status.component */ "./src/app/main/operations/services-status/services-status.component.ts");
/* harmony import */ var _services_log_services_log_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./services-log/services-log.component */ "./src/app/main/operations/services-log/services-log.component.ts");
/* harmony import */ var _operations_route__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./operations.route */ "./src/app/main/operations/operations.route.ts");
/* harmony import */ var src_app_shared_module__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! src/app/shared.module */ "./src/app/shared.module.ts");
...
var operationsComponents = [
    _operations_component__WEBPACK_IMPORTED_MODULE_9__["OperationsComponent"],
    _operations_file_exception_file_exception_component__WEBPACK_IMPORTED_MODULE_10__["FileExceptionComponent"],
    _operations_file_management_file_management_component__WEBPACK_IMPORTED_MODULE_11__["FileManagementComponent"],
    _operations_file_upload_file_upload_component__WEBPACK_IMPORTED_MODULE_12__["FileUploadComponent"],
    src_app_main_operations_silver_file_management_silver_file_management_component__WEBPACK_IMPORTED_MODULE_13__["SilverFileManagementComponent"],
    src_app_main_operations_services_status_services_status_component__WEBPACK_IMPORTED_MODULE_14__["ServicesStatusComponent"],
    _services_log_services_log_component__WEBPACK_IMPORTED_MODULE_15__["ServicesLogComponent"]
];
var OperationsModule = /** @class */ (function () {
    ...
    OperationsModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            exports: operationsComponents.concat([src_app_shared_module__WEBPACK_IMPORTED_MODULE_17__["SharedModule"]]),
            imports: [
                ...
                _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild(_operations_route__WEBPACK_IMPORTED_MODULE_16__["OperationsRoutes"]),
                angular_split__WEBPACK_IMPORTED_MODULE_7__["AngularSplitModule"],
                lp_toolkit__WEBPACK_IMPORTED_MODULE_8__["LpToolkitModule"],
                src_app_shared_module__WEBPACK_IMPORTED_MODULE_17__["SharedModule"]
            ]
        })
    ], OperationsModule);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".card-wrapper {\n  max-width: 100%;\n  margin: 4px;\n  transition: box-shadow 280ms cubic-bezier(0.4, 0, 0.2, 1);\n  display: block;\n  position: relative;\n  padding: 12px;\n  border-radius: 4px;\n  background: #fff;\n  color: rgba(0, 0, 0, 0.87);\n  font-family: Roboto, \"Helvetica Neue\", sans-serif;\n  box-shadow: 0 2px 1px -1px rgba(0, 0, 0, 0.2), 0 1px 1px 0 rgba(0, 0, 0, 0.14), 0 1px 3px 0 rgba(0, 0, 0, 0.12);\n}\n\n.form_wrapper {\n  box-sizing: border-box;\n  margin: 65px auto;\n  width: 100%;\n  padding-bottom: 2px;\n  box-shadow: 0 5px 15px 1px rgba(0, 0, 0, 0.6), 0 0 200px 1px rgba(255, 255, 255, 0.5);\n  border-radius: 2px;\n}\n\n.form_wrapper h3 {\n  padding: 20px;\n  background: #eee;\n}\n\n.icon-wrap {\n  margin: 17px 14px;\n}\n\n.m-top-10 {\n  margin-top: 10%;\n}\n\n.title-bg-color {\n  background: #eee;\n}\n\n.status {\n  border-radius: 25px;\n  color: #ffffff;\n  height: 29px;\n  width: 95px;\n  padding: 2px 19px;\n}\n\n.label-p {\n  color: rgba(0, 0, 0, 0.87);\n  font-weight: 500;\n  padding: 0 0 0 34px;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
