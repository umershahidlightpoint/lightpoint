import {
  Component, TemplateRef, ElementRef, OnInit, Injector, Input, ViewChild, EventEmitter,
  Output, ViewEncapsulation, AfterViewInit
} from '@angular/core';
...
export class AgGridExampleComponent implements OnInit, AfterViewInit {
  ...
  ranges: any = {
    ...
    'ITB': [moment("01-01-1901", "MM-DD-YYYY"), moment()],
    'YTB': [moment().startOf('year'), moment()],
    'MTB': [moment().startOf('month'), moment()]
  ...
  ngAfterViewInit() {
    ...
    this.pivotColumnGroupTotals = "always";
