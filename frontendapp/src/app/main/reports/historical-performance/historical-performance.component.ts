...
export class HistoricalPerformanceComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  getReport(date, symbol, fund) {
    console.log(date,"LLLLLLLLLLLLLLLLLLLLLLLLLLLLLL");
    this.isLoading = true;
    this.gridOptions.api.showLoadingOverlay();
    this.reportsApiService
      .getHistoricPerformanceReport(moment(date).format('YYYY-MM-DD'), moment(date).format('YYYY-MM-DD'))
      .subscribe(response => {
        this.reportData = response.payload;
        console.log(this.reportData,"tHHHHHHHHHHHHHHHHHHHHHH++++++++++++++");
